  ...
  return (
    <footer className="bg-zinc-800 text-white py-10">
      <div className="max-w-7xl mx-auto flex flex-col sm:px-6 lg:px-[185px] space-y-10 lg:space-y-0 lg:flex-row lg:justify-between">
        ...
        <div className="flex-1 p-4 lg:ml-6 lg:text-left">
          <h2 className="text-2xl  font-bold">Newsletter</h2>
          <form className="mt-4 md:mt-12 flex flex-col md:flex-row lg:flex-col lg:gap-4 md:items-center lg:items-start space-y-4 md:space-y-0">
            <input  
              type="email" 
