...
const Sliderr = () => {
  ...
  const NextArrow = () => (
    <div
      className="bg-red-500 w-8 h-6 md:w-10 md:h-6 cursor-pointer  text-black hover:bg-white rounded-lg absolute bottom-[20%] right-4 md:bottom-[25%] lg:bottom-[22%] md:right-4 lg:right-[-10px] z-10 sm:right-2"
